              ...
              <li key={item.title} className=" relative group ">
                {item.items ? (
                  <>
                    ...
                    <div className="bg-[#F2EAE0] invisible absolute left-0 top-full z-50 mt-2 w-80 translate-y-2 rounded-md  p-1 text-popover-foreground opacity-0 shadow-lg transition-all group-hover:visible group-hover:translate-y-0 group-hover:opacity-100">
