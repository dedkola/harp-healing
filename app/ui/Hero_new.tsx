...
export default function Hero_new() {
    return (
        <section className="bg-gradient-to-b from-[#e1bc8f] via-[#ecd8ae] to-[#f1e6dc] flex justify-center items-center min-h-screen p-6">
            <div className="max-w-5xl w-full bg-[#E1D4C7] rounded-2xl shadow-md overflow-hidden">
            {/* Image Background Section */}
                <div
                    className="relative h-[700px] flex flex-col justify-start bg-cover bg-center"
                    style={{
                        backgroundImage: "url('/hires/krea-edit (2)-topaz-upscale-4x.png')", // replace with your own image path
                    }}
                >
