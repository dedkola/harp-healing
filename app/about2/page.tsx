  ...
  return (
    ...
    <section className="relative isolate bg-[#F2EAE0]">
      {/* Background image */}
        <Navbar1 />
      <div
        className="absolute inset-0 -z-10 bg-center bg-no-repeat bg-cover aspect-[3/2] "
      ...
      <div className="mx-auto max-w-2xl px-6  sm:py-4 lg:py-88 text-center aspect-[3/2]">
