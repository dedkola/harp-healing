...
export default function Page() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#e1bc8f] via-[#ecd8ae] to-[#f7e9d2]">
    ...
    <Navbar1 />
        <section className="relative isolate">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/hires/enhanced_002.png')" }}
            />
            ...
            <div className="mx-auto max-w-2xl px-6 py-32 sm:py-40 lg:py-70 text-center">
                ...
                <h1 className="text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-yellow-100 to-amber-300"> Crystal Harp Healing</h1>
