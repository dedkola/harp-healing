  ...
  return (
    ...
    <main className="px-6">
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8">
        <div className="md:w-2/3 text-center text-amber-800 !font-thin space-y-4">
          <h2 className="text-4xl text-amber-800 !font-thin pb-2 pt-2">Ways to Experience Healing
   ...
   <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
     <article className="flex flex-col items-start gap-3 bg-gradient-to-br from-white/70 to-amber-50/60 backdrop-blur-sm border border-amber-200/30 rounded-2xl p-6 shadow-2xl ring-1 ring-amber-100 transition-shadow hover:shadow-[0_20px_40px_rgba(193,154,107,0.18)]">
       <h4 className="text-xl md:text-2xl text-amber-800 font-semibold">Individual Sessions</h4>
       <p className="text-sm text-gray-800/90">
         ...
         Ideal for stress, anxiety, trauma recovery, or emotional imbalance.
       </p>
     </article>
     ...
     <article className="flex flex-col items-start gap-3 bg-gradient-to-br from-white/70 to-amber-50/60 backdrop-blur-sm border border-amber-200/30 rounded-2xl p-6 shadow-2xl ring-1 ring-amber-100 transition-shadow hover:shadow-[0_20px_40px_rgba(193,154,107,0.18)]">
       ...
       <p className="text-sm text-gray-800/90">
         Shared vibrational experience for families, friends, or circles.
         Supports connection, co-regulation, and shared peace.
       </p>
     </article>

     <article className="flex flex-col items-start gap-3 bg-gradient-to-br from-white/70 to-amber-50/60 backdrop-blur-sm border border-amber-200/30 rounded-2xl p-6 shadow-2xl ring-1 ring-amber-100 transition-shadow hover:shadow-[0_20px_40px_rgba(193,154,107,0.18)]">
       <h4 className="text-xl md:text-2xl text-amber-800 font-semibold">Sound Baths & Events</h4>
       <p className="text-sm text-gray-800/90">
         Public or private gatherings where crystal harp frequencies create deep meditative states and energetic clearing.
          ...
          <p>
            Complimentary introductory consultation available.
          </p>


          <div className="h-px bg-gradient-to-r from-transparent via-[#c19a6b]/40 to-transparent mb-10"></div>

          <h2 className="text-4xl text-amber-800 !font-thin pb-2 pt-2">Offerings — Ways to Experience Healing
      ...
      <tbody className="divide-y divide-amber-100">
        <tr>
          ...
          <td className="py-4 text-sm text-gray-800 pl-4">
            90 minute personalized sound healing with emotional regulation and gentle somatic attunement. Ideal for stress, anxiety, energetic realignment, or emotional imbalance.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="py-4 text-sm text-gray-800 pl-4">
            ...
            <p>Complimentary introductory consultation available.
            </p>
